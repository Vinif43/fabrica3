...
export function StudentsTable({ students, date, search }: StudentsTableProps) {
  ...
  const renderPresenceStatus = (existingPresence: Presence | undefined) => {
    if (!existingPresence) {
      return (
        // <div className="flex flex-col md:flex-row gap-4">
        //   <button
        //     onClick={() => handlePresenceChange(existingPresence!.aluno, 'PR')}
        ...
        //   </button>
        //   <button
        //     onClick={() => handlePresenceChange(existingPresence!.aluno, 'JU')}
        ...
        //   </button>
        //   <button
        //     onClick={() => handlePresenceChange(existingPresence!.aluno, 'AU')}
        ...
        {filteredStudents.map((student) => {
          ...
          return (
            ...
            >
              ...
              <p>RGM: {student.rgm}</p>
              <div className="mt-4">
                {renderPresenceStatus(existingPresence)}
              </div>
            </div>
          )
        })}
